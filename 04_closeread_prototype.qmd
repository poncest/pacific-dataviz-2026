...
<div class="header-row">
  <div class="eyebrow">SEA LEVEL RISE (SLR) · TUVALU · PACIFIC DATAVIZ CHALLENGE 2026</div>
...
<div class="standfirst">
  ...
  <p>Funafuti Atoll, home to most of Tuvalu's population, rises only a few meters above the Pacific Ocean. Half a degree of warming sounds incremental; on a low-lying atoll it can become geographic. The scenarios below are illustrative thresholds, not precise projections — see the methodology.</p>
</div>
...
![](output/05_supporting/funafuti_exposure_slope.png)
